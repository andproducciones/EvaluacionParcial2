...
//c.consulta_id, c.fecha, c.motivo_consulta, p.nombre AS paciente_nombre, p.apellido AS paciente_apellido, m.nombre AS medico_nombre,c.paciente_id, c.medico_id
	...
	$dataconsulta = $Consultas->getConsultaById($id);
	...
	$pdf->SetFont('Arial','',10);
	$pdf->SetTextColor(39,39,51);
	$pdf->Cell(13,7,iconv("UTF-8", "ISO-8859-1","Medico Tratante: ". $medico),0,0);
	
	$pdf->Ln(7);

	$pdf->SetFont('Arial','',10);
	$pdf->SetTextColor(39,39,51);
	$pdf->Cell(13,7,iconv("UTF-8", "ISO-8859-1","Fecha: ". $fecha),0,0);
	...
	$pdf->SetFont('Arial','',10);
	$pdf->SetTextColor(39,39,51);
	$pdf->Cell(13,7,iconv("UTF-8", "ISO-8859-1","Motivo: ". $motivo),0,0);
